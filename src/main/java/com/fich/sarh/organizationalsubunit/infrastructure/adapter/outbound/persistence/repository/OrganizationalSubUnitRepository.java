package com.fich.sarh.organizationalsubunit.infrastructure.adapter.outbound.persistence.repository;
...
public interface OrganizationalSubUnitRepository extends JpaRepository<OrganizationalSubUnitEntity, Long> {
    ...
    List<OrganizationalSubUnitEntity>findByNameSubUnit(String name);
