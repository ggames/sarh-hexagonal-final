package com.fich.sarh.organizationalunit.infrastructure.adapters.outbound.persistence.repository;
...
public interface OrganizationalUnitRepository extends JpaRepository<OrganizationalUnitEntity, Long> {
    ...
    List<OrganizationalUnitEntity> findByNameUnit(String nameUnit);
