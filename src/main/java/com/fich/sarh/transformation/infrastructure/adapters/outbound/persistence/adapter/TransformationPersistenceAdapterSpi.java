...
@PersistenceAdapter
public class TransformationPersistenceAdapterSpi implements
        TransformationRetrieveSpiPort, TransformationSaveSpiPort, TransformationLoadSpiPort {

    private final TransformationRepository transformationRepository;

    public TransformationPersistenceAdapterSpi(TransformationRepository transformationRepository) {
